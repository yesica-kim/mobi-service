...
### v1.3.0 자동 백업/복구
- 자동 백업은 최근 20개까지 보관.
- 백업 기준: 하루 첫 접속, 기본 숙제 설정 불러오기 전, 빈 리스트로 시작 전, 저장한 리스트 불러오기 전, 백업 파일 가져오기 전, 이전 데이터 복구 전, 캐릭터 삭제 전, 체크박스 초기화 전, 캐릭터 추가 후.
...
- **v1.3.0 후보**: 캐릭터 전체 보기/캐릭터별 보기에서 캐릭터 숙제 전체 체크 기능
