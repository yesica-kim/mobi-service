...
export const UPDATE_NOTES: UpdateNote[] = [
  {
    ...
    date: "2026-05-28",
    changes: [
      "주요 변경 작업 전후에 최근 상태를 자동 백업하도록 추가",
  ...
  },
  {
    ...
    date: "2026-05-26",
    changes: [
      "캐릭터 전체 보기 화면 추가 및 모바일 전용 UI 개선",
      "캐릭터별 보기/전체 보기 전환 기능 추가",
      "빈 리스트로 시작하고 필요할 때 기본 숙제 설정을 불러오도록 변경",
      "현재 리스트 저장, 저장한 리스트, 백업/복원, 빈 리스트로 시작 구조로 숙제 설정 정리",
      "카드 수정 화면을 공통 레이어 방식으로 개선",
      "기본 카드와 개인 카드 모두 수정/삭제 가능하도록 변경",
