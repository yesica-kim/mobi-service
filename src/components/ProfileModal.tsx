          ...
          {page === "menu" ? (
            <div className="p-6">
              ...
              {isGuest && onSignInWithGoogle && (
                <button
                  onClick={() => { onSignInWithGoogle(); handleClose(); }}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm bg-blue-600 hover:bg-blue-500 transition-colors mb-4 font-medium"
                >
