    ...
    <div className="px-4 pt-3">
      <div className="rounded-xl bg-slate-800/60 border border-slate-700/50 overflow-hidden">
        ...
        <button
          ...
          className="flex h-12 w-full items-center justify-between px-3 text-sm transition-colors hover:bg-slate-800/40"
        >
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="flex-shrink-0 font-medium text-slate-300">메모장</span>
            {hasMemo && (
              <span className="flex-shrink-0 rounded-full bg-blue-600/20 px-1.5 py-0.5 text-xs font-bold text-blue-400">작성됨</span>
            )}
            {saved && <span className="flex-shrink-0 text-xs text-green-400">저장됨!</span>}
          </div>
